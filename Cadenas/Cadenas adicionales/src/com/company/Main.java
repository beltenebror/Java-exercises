...
//                las 26 letras del abecedario. No uséis un switch (ni 26 ifs). Perdón, 27, se me olvidaba la eñe.
            ...
            case 4:
            {
                ...
                String a="CinTia eS la meJor ¿qie tal? . HOLA";
                ...
                System.out.println("• 4 = La primera letra de cada frase en mayúsculas y el resto en mayúsculas.");
    ...
    public static String mayusculasMinusculas(String a,int funcion)
    {
        ...
        switch (funcion)
        {
            ...
            case 4:
            {
                ...
                devolver=a.toLowerCase();
                devolver=quitaEspaciosSobrantes(devolver);
                String [] frases= devolver.split("[\\.!?]"); //esto caca , hay que hacerlo con un for, y si me encuentro esto el siguietne en mayus
                for(int i=0;i<frases.length;i++)
                {
                    temporal=frases[i];
                    temporal = Character.toUpperCase(temporal.charAt(0)) + temporal.substring(1);
                    frases[i]=temporal;
