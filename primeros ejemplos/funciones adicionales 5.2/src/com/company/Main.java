...
public class Main
{
      ...
      // pirámide a base de estrellitas como la del ejemplo. La función deberá funcionar para cualquier número
      // entre 3 y 20 (o sea, nada de escribir las estrellitas a mano).
